...
| [`flows/people_management_flow_v1.md`](flows/people_management_flow_v1.md) | People management (volunteers + captains) | BM-24 | Merged |
| [`flows/finances_flow_v1.md`](flows/finances_flow_v1.md) | Finances (issues, payouts) | BM-25 | Draft |
