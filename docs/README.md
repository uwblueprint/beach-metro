...
| `people_management_flow_v1.md` | People management (volunteers + captains) | BM-24 | Skeleton | `docs/` on this branch |
| `finances_flow_v1.md` | Finances (issues, deliveries, payouts) | BM-25 | Skeleton | `docs/` on this branch |
